    ...
    <BlogEntry title="A Refresher" date="January 22nd, 2026" subtitle="Trying something new">
        <div>
            <div>
                ...
                I've also added some functionality like making this a single page app or adding <InlineMath math="\LaTeX"/>.
                <BR/>
                <BlockMath math="(\forall p,a,b \in \mathbb{N})[(P(p) \land p|ab) \implies (p|b\lor p|a)]"/>
